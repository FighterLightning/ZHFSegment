...
import UIKit
// "有导航栏，没有tabBar",
class MainThreeChildVC: UIViewController {
    ...
    func setUI(){
         ...
         */
        let viewHeight = ScreenHeight - navH - titleHeight
...
extension MainThreeChildVC :UITableViewDataSource,UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            //通知刷新角标
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: refreshMainThreeAngle), object: nil, userInfo: nil)
        }
    }
