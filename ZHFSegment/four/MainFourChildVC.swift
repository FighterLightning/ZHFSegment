...
class MainFourChildVC: UIViewController {
    var titleHeight: CGFloat = 44.0 //这个是titleScroolView的高，为了精确确定确定self.View的高，我这里传过来使用，仅供参考
    ...
    func setUI(){
        /* self.view 的高
         ...
         barH: tabBar高度
         */
        let viewHeight = ScreenHeight - navH - titleHeight - barH
...
extension MainFourChildVC :UITableViewDataSource,UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            //通知刷新角标
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: refreshMainFourAngle), object: nil, userInfo: nil)
        }
    }
