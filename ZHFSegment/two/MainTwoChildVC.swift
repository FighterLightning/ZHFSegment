...
import UIKit
//"没有导航栏，有tabBar",
class MainTwoChildVC: UIViewController {
    ...
    func setUI(){
        /*
         ...
         barH: tabBar高度
         */
         let viewHeight = ScreenHeight - (navH - 44) - titleHeight - barH
...
extension MainTwoChildVC :UITableViewDataSource,UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            //通知刷新角标
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: refreshMainTwoAngle), object: nil, userInfo: nil)
        }
    }
